<?php
  include "conecta.php";
  session_start();
  $nm_materia=$_GET["nm_materia"];
  //echo $nm_materia;

  $consulta = "SELECT conteudo, arquivo, id_material FROM tb_material WHERE nm_materia=".$nm_materia.";";
 // echo $consulta;
...
<body>
  ...
  <div class='container'>
    <div class="row">
    <div class="col"style="background:transparent;margin-top:10%;margin-left:20px;margin-right:20px;height:700px; width: 200px;">
      <center>
                ...
                <?php
                      for($i = 0; $i < count($conteudo); $i++){
                       ...
                       // echo "<a href= 'forum.php?id_material=".$id_material[$i]."' >Tire sua dúvida aqui</a>";
                        echo "<h5><button class='btn btn-primary' type='submit' name='id_material' value='".$id_material[$i]."' > Tire sua dúvida aqui, sobre o material! </button></h5>";
