...
$query = "INSERT INTO livraria.tb_pessoa (id_pessoa, nm_pessoa, ds_email, senha, f_isFuncionario, nu_cpf) VALUES ($1, $2, $3, $4,'0', $5)";
$params = array($id_pessoa, $nome, $email, $senhaHash, $cpf);
